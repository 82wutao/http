...
public class Record implements Serializable {
	...
	private Map<String, Object> columns = new HashMap<String, Object>();	// = getColumnsMap();	// getConfig().containerFactory.getColumnsMap();	// new HashMap<String, Object>();
