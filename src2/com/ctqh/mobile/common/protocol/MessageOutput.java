...
public class MessageOutput {
	protected static final Logger logger = LoggerFactory.getLogger(MessageOutput.class);
	 ...
	 * @param msgCode
	 */
	public MessageOutput(int msgCode) {
...
//
//	public MessageOutput(int initialSize,int msgCode) {
...
//	}
	 ...
	 * @param param
	 */
	public MessageOutput(int msgCode,int errorNum,String[] param) {
		output = ByteBuffer.allocate(64);
		capacity = 64;
...
//	}
	...
	private static void needMoreBuffer(MessageOutput msg, int bytes) {
...
//	}
	...
	public final IoBuffer toMinaBuffer() {
		logger.info("send to client " + msgCode);
		if (minaOut == null) {
			byte[] body = null;
			body = output.array();
...
//			}
			...
			output.putShort(0, (short)msgCode);
			output.put(2, (byte) (magicNum==0?MagicNum:magicNum));
			output.putInt(3, length-7);
