...
public abstract class AbstractPollingIoConnector<T extends AbstractIoSession, H> extends AbstractIoConnector {
    ...
    protected AbstractPollingIoConnector(IoSessionConfig sessionConfig, 
    		Class<? extends IoProcessor<T>> processorClass,
    				Executor ioEventExecutor,Executor ioProcesseExecutor) {
        this(sessionConfig, ioEventExecutor, new SimpleIoProcessorPool<T>(processorClass,ioProcesseExecutor), true);
    }
    /**
     * Constructor for {@link AbstractPollingIoConnector}. You need to provide a default
     * session configuration, a class of {@link IoProcessor} which will be instantiated in a
