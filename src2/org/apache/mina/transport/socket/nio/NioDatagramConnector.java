...
public final class NioDatagramConnector extends AbstractPollingIoConnector<NioSession, DatagramChannel> implements
    ...
    public NioDatagramConnector(Executor ioEventExecutor,Executor ioProcesseExecutor) {
        super(new DefaultDatagramSessionConfig(), NioProcessor.class,ioEventExecutor,ioProcesseExecutor);
    }
    /**
     * Creates a new instance.
     */
