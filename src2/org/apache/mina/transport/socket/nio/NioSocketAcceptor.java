...
/**
 * 非阻塞Socket接收器。处理TCP/IP的连接。<br>
 * {@link IoAcceptor} for socket transport (TCP/IP). <br>
...
//    }
    ...
    public NioSocketAcceptor(int processorCount,Executor executor) {
        super(new DefaultSocketSessionConfig(), NioProcessor.class, processorCount,executor);
        ((DefaultSocketSessionConfig) getSessionConfig()).init(this);
    }
